...
export const experienceCatalog: Experience[] = [
  {
    ...
    shortDescription: "A experiencia de praia mais iconica do Marajo com por do sol, paisagem aberta e curadoria local.",
    category: "beach",
    destinationSlug: "pesqueiro",
    locationLabel: "Soure - Ilha de Marajo",
    duration: "4 horas",
    priceFrom: 250,
    currency: "BRL",
    ...
    featured: true,
    active: true,
    seoTitle: "Praia do Pesqueiro no Marajo: experiencia de praia e por do sol",
    seoDescription: "Descubra a Praia do Pesqueiro com curadoria local, paisagem marajoara, suporte humano e uma das experiencias mais reservadas da ilha.",
    ...
    media: {
      ...
      altByLocale: {
        pt: "Praia do Pesqueiro ao por do sol em Marajo",
    ...
    translations: {
      pt: {
        ...
        shortDescription: "A experiencia de praia mais iconica do Marajo com por do sol, paisagem aberta e curadoria local.",
        fullDescription:
          "Uma experiencia classica para quem quer sentir o lado mais fotografico do Marajo. Praia ampla, apoio local e uma leitura mais premium do destino.",
        locationLabel: "Soure - Ilha de Marajo",
        durationLabel: "4 horas",
        highlights: ["Por do sol emblematico", "Paisagem aberta", "Leitura facil para primeira viagem", "Suporte humano"],
        included: ["Curadoria da experiencia", "Orientacao local", "Suporte pre-viagem"],
      },
      en: {
        ...
        locationLabel: "Soure - Marajo Island",
  ...
  },
  {
    ...
    shortDescription: "Vivencia rural com fazenda, queijo marajoara e forte leitura cultural do destino.",
    category: "culture",
    ...
    featured: true,
    active: true,
    seoTitle: "Circuito de bufalos e queijo no Marajo: fazenda, cultura e sabor",
    seoDescription: "Conheca uma experiencia rural no Marajo com queijo marajoara, cultura bufala e apoio local para viajantes que buscam identidade e autenticidade.",
    ...
    media: {
      ...
      altByLocale: {
        pt: "Vivencia de fazenda e queijo no Marajo",
    ...
    translations: {
      pt: {
        ...
        shortDescription: "Vivencia rural com fazenda, queijo marajoara e forte leitura cultural do destino.",
        fullDescription:
          "Uma experiencia desenhada para conectar fazenda, queijo e identidade local em um formato facil de encaixar em roteiros de primeira viagem.",
        locationLabel: "Soure",
        durationLabel: "5 horas",
        highlights: ["Fazenda local", "Queijo marajoara", "Leitura cultural", "Boa combinacao com praia"],
        included: ["Guia local", "Degustacao", "Transfer interno"],
      },
      en: {
  ...
  },
  {
    ...
    shortDescription: "Saida de barco em ritmo calmo com leitura de aves, rios e ecossistema preservado.",
    category: "wildlife",
    ...
    featured: true,
    active: true,
    seoTitle: "Manguezais de Salvaterra: natureza, aves e passeio de barco no Marajo",
    seoDescription: "Explore os manguezais de Salvaterra com observacao de aves, paisagem preservada e uma experiencia lenta pensada para natureza e descoberta.",
    ...
    translations: {
      pt: {
        ...
        shortDescription: "Saida de barco em ritmo calmo com leitura de aves, rios e ecossistema preservado.",
        fullDescription:
          "Uma experiencia pensada para observacao e contemplacao, ideal para viajantes que querem ver o lado mais natural do Marajo sem pressa.",
        locationLabel: "Salvaterra",
        durationLabel: "3 horas",
        highlights: ["Passeio de barco", "Observacao de aves", "Natureza preservada", "Ritmo tranquilo"],
        included: ["Guia local", "Equipamento basico", "Seguro"],
      },
      en: {
  ...
  },
  {
    ...
    shortDescription: "Uma experiencia classica do Marajo com cavalo, praia aberta e forte apelo fotografico.",
    category: "horseback",
    destinationSlug: "soure",
    locationLabel: "Soure",
    duration: "2h30",
    ...
    featured: true,
    active: true,
    seoTitle: "Cavalgada na praia no Marajo: experiencia a cavalo e paisagem aberta",
    seoDescription: "Planeje uma cavalgada na praia no Marajo com paisagem aberta, leitura cultural do destino e uma experiencia fotogenica de baixa dificuldade.",
    ...
    media: {
      ...
      altByLocale: {
        pt: "Cavalgada na praia no Marajo",
    ...
    translations: {
      pt: {
        ...
        shortDescription: "Uma experiencia classica do Marajo com cavalo, praia aberta e forte apelo fotografico.",
        fullDescription:
          "Uma saida guiada pensada para quem quer paisagem ampla e movimento leve, com leitura autentica da cultura de campo e praia da ilha.",
        locationLabel: "Soure",
        durationLabel: "2h30",
        highlights: ["Praia aberta", "Apelo fotografico", "Ritmo acessivel", "Leitura do territorio"],
        included: ["Cavalo preparado", "Equipamento basico", "Seguro"],
      },
      en: {
  ...
  },
  {
    ...
    title: "Expedicao de observacao de aves",
    shortDescription: "Saida de campo focada em aves, paisagem aberta e fotografia de natureza no Marajo.",
    category: "wildlife",
    destinationSlug: "salvaterra",
    ...
    featured: false,
    active: true,
    seoTitle: "Birdwatching no Marajo: expedicao de observacao de aves e natureza",
    seoDescription: "Planeje uma expedicao de birdwatching no Marajo com foco em habitats abertos, fotografia e leitura de natureza com apoio local.",
    ...
    translations: {
      pt: {
        ...
        shortDescription: "Saida de campo focada em aves, paisagem aberta e fotografia de natureza no Marajo.",
        fullDescription:
          "Uma experiencia para viajantes que priorizam natureza, observacao e tempo de leitura de habitat antes de transformar a viagem em um roteiro mais amplo.",
        locationLabel: "Salvaterra e campos alagados",
        durationLabel: "4h30",
        highlights: ["Habitats abertos", "Leitura de fauna", "Boa para fotografia", "Saida curada"],
        included: ["Guia local", "Janela recomendada", "Suporte pre-viagem"],
      },
      en: {
  ...
  },
  {
    ...
    title: "Passeio de barco por igarapes",
    shortDescription: "Uma saida leve de barco para ler rios, canais e o ritmo mais contemplativo do Marajo.",
    category: "boat",
    destinationSlug: "salvaterra",
    locationLabel: "Salvaterra",
    duration: "3h30",
    ...
    featured: false,
    active: true,
    seoTitle: "Passeio de barco nos igarapes do Marajo: rios, paisagem e descoberta lenta",
    seoDescription: "Descubra um passeio de barco pelos igarapes do Marajo com foco em paisagem, ritmo calmo e combinacao com roteiros de natureza.",
    ...
    translations: {
      pt: {
        ...
        shortDescription: "Uma saida leve de barco para ler rios, canais e o ritmo mais contemplativo do Marajo.",
        fullDescription:
          "Uma experiencia pensada para quem quer navegar sem pressa, entender o territorio de agua e combinar a saida com outros roteiros de natureza.",
        locationLabel: "Salvaterra",
        durationLabel: "3h30",
        highlights: ["Ritmo contemplativo", "Boa combinacao com natureza", "Leitura de rios", "Saida acessivel"],
        included: ["Barco local", "Guia", "Orientacoes gerais"],
      },
      en: {
  ...
  },
  {
    ...
    title: "Experiencia de pesca esportiva",
    shortDescription: "Saida orientada para pesca e leitura de agua com apoio local e posicionamento premium.",
    category: "fishing",
    destinationSlug: "soure",
    ...
    featured: false,
    active: true,
    seoTitle: "Pesca esportiva no Marajo: experiencia de agua e curadoria local",
    seoDescription: "Planeje uma experiencia de pesca esportiva no Marajo com apoio local, leitura de agua, ritmo ajustado e integracao com roteiros premium.",
    ...
    translations: {
      pt: {
        ...
        shortDescription: "Saida orientada para pesca e leitura de agua com apoio local e posicionamento premium.",
        fullDescription:
          "Uma experiencia comercialmente forte para perfis que querem atividade, agua e acompanhamento local sem transformar a viagem em operacao complexa.",
        locationLabel: "Soure e arredores",
        durationLabel: "6 horas",
        highlights: ["Saida focada", "Leitura de agua", "Apoio local", "Boa para perfis ativos"],
        included: ["Guia local", "Apoio operacional basico", "Orientacoes de saida"],
      },
      en: {
