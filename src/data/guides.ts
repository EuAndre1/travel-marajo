...
export const guides: GuideContentItem[] = [
  {
    ...
    seoTitle: "Things to Do in Marajó Island: Experiences, Culture and Nature Guide",
    seoDescription: "Discover the best things to do in Marajó Island, from beaches and buffalo culture to wildlife, curated experiences, and practical trip planning.",
    heroTitle: "Things to do in Marajó Island",
    ...
    sections: [
      ...
      { title: "Logistics that matter", body: "Most visitors arrive via Belém and choose Soure or Salvaterra as a base. A good plan reduces transfer friction and sequences experiences in advance." },
  ...
  },
  {
    ...
    title: "How to visit Marajó Island",
    seoTitle: "How to Visit Marajó Island: Routes, Logistics and Trip Planning",
    seoDescription: "Learn how to visit Marajó Island with practical logistics, destination bases, seasonal guidance, and curated planning tips for international and Brazilian travelers.",
    heroTitle: "How to visit Marajó Island",
    ...
    sections: [
      { title: "Gateway strategy", body: "Belém is the main access point for most travelers. From there, visitors organize the river crossing and continue to the island's tourism bases." },
    ...
    faq: [
      { question: "What is the easiest way to visit Marajó Island?", answer: "The easiest route is to use Belém as the main gateway, choose Soure or Salvaterra as your base, and book core experiences before arrival." },
  ...
  },
  {
    ...
    seoTitle: "Best Time to Visit Marajó Island: Seasons, Weather and Travel Planning",
    seoDescription: "Understand the best time to visit Marajó Island for beaches, wildlife, logistics, buffalo culture, and premium destination planning.",
    heroTitle: "Best time to visit Marajó Island",
  ...
  },
  {
    ...
    title: "Marajó Island travel guide",
    seoTitle: "Marajó Island Travel Guide: Where to Go, What to Do and How to Plan",
    seoDescription: "A complete Marajó Island travel guide covering destinations, experiences, seasonality, culture, logistics, and booking-ready travel planning.",
    heroTitle: "Marajó Island travel guide",
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Logistics edge", body: "Marajo can be framed as an accessible extension from Belém, which gives it a practical advantage over less structured remote travel ideas." },
  ...
  },
  {
    ...
    seoDescription: "Discover birdwatching in Marajó Island with the best habitats, seasonal timing, mangrove routes, and curated planning tips for nature-focused travelers.",
  ...
  },
  {
    ...
    seoDescription: "Discover the best beaches in Marajó Island, from iconic scenery to relaxed coastal stops, with travel tips, seasonality, and trip-planning guidance.",
