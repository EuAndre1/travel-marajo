...
export const metadata = buildServiceMetadata({
  ...
  description:
    "Explore premium travel services from Travel Marajó including Brazil visa consulting, custom travel planning, and concierge assistance.",
  path: "/services",
